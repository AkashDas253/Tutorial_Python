...
### Short Overview
- [Tensors](lessons/core/readme.md)
- [Data Pipeline](lessons/data_pipeline/readme.md)
- [Building Models](lessons/model_build/readme.md)
- [Layers](lessons/layer/readme.md)
- [Training](lessons/model_train/readme.md)
- [Model Evaluation and Testing](lessons/model_evaluation/readme.md)
- [Visualization](lessons/visualization/readme.md)
- [Keras](lessons/keras/readme.md)

### Beyond Basics
- [Advanced Topics](lessons/advance/readme.md)
- [TensorFlow Ecosystem](lessons/ecosystem/readme.md)
- [Specialized Libraries and Add-ons](lessons/libraries/readme.md)

### In Depth
- [Core Concepts](lessons/core/readme.md)
...
- Machine Learning
    - [Estimators API](lessons/estimator_api/readme.md)
...
- Deep Learning
    ...
    - [Model Building](lessons/model_build/readme.md)
        - [Layers](lessons/layer/readme.md)
        - [Layers (`tf.keras.layers`)](lessons/layer_keras/readme.md)
   ...
   - [Model Evaluation and Testing](lessons/model_evaluation/readme.md)
     - Metrics
     - Cross-validation
   - [Model Saving and Loading](lessons/model_save/readme.md)
     - [SavedModel format](lessons/savedmodel/readme.md)
     - [HDF5 format](lessons/hdf5/readme.md)

- [TensorFlow Keras](lessons/keras/readme.md)
   - [Layers](lessons/layer_keras/readme.md)
   - [Callbacks](lessons/callbacks/readme.md)
   - [Custom Layers and Models](lessons/custom_layer_model/readme.md)
   - [Pretrained Models](lessons/model_pretrained/readme.md)
     - [Transfer learning](lessons/transfer_learning/readme.md)
     - [Fine-tuning](lessons/fine_tuning/readme.md)
